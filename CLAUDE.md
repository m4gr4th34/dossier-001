...
## Standing context
- Open challenge C11 (nonlocal imaging derivation) is OPEN-UNVERIFIED
  by design; first correct treatment gets credit in v1.1.
- The author reviews by consistency and reality checks, not
  re-derivation. Surface anything that looks inconsistent.
